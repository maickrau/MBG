...
int main(int argc, char** argv)
{
	...
	runMBG(inputReads, outputGraph, kmerSize, windowSize, minCoverage, minUnitigCoverage, hpc, collapseRunLengths, blunt, numThreads, dinucRle, includeEndKmers, outputSequencePaths);
}