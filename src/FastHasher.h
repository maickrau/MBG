...
private:
	...
	uint64_t fwAdd[30];
	uint64_t fwRemove[30];
	uint64_t bwAdd[30];
	uint64_t bwRemove[30];
	...
	uint64_t charHashes[30] { 0, 0x3c8bfbb395c60474, 0x3193c18562a02b4c, 0x20323ed082572324, 0x295549f54be24456, combineHash(hashA, hashC), combineHash(hashA, hashG), combineHash(hashA, hashT), combineHash(hashC, hashA), combineHash(hashC, hashG), combineHash(hashC, hashT), combineHash(hashG, hashA), combineHash(hashG, hashC), combineHash(hashG, hashT), combineHash(hashT, hashA), combineHash(hashT, hashC), combineHash(hashT, hashG), combineHash(hashA, hashC), combineHash(hashA, hashG), combineHash(hashA, hashT), combineHash(hashC, hashA), combineHash(hashC, hashG), combineHash(hashC, hashT), combineHash(hashG, hashA), combineHash(hashG, hashC), combineHash(hashG, hashT), combineHash(hashT, hashA), combineHash(hashT, hashC), combineHash(hashT, hashG), 0x123456789abcdef0 };
	uint64_t fwHash;
	uint64_t bwHash;
	size_t kmerSize;
};
